<div class="button-box">
    <a href="#" onclick="add()" alt="default" data-toggle="modal" data-target="#modal_form" type="button" class="fcbtn btn btn-primary btn-outline btn-1b waves-effect">Tambah Baru</a>
