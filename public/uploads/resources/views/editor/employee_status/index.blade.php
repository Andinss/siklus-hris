    ...
    <div class="modal-content">
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="modal-header">
         ...
         <h4 class="modal-title">Status Karyawan Form</h4>
       </div>
       <div class="modal-body"> 
         <div class="form-body">
            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
              <label class="control-label col-md-4 pull-left">Status Karyawan</label>
              <div class="col-md-8">
                <input name="employee_status_name" id="employee_status_name" class="form-control" type="text">
...
<script> 
  ...
  $(document).ready(function() {
      ...
      table = $('#dtTable').DataTable({ 
       ...
       ajax: "{{ URL::route('editor.employee-status.data') }}",
       columns: [  
       { data: 'action', name: 'action', orderable: false, searchable: false }, 
       { data: 'employee_status_name', name: 'employee_status_name' }, 
    ...
    function add()
    {
      ...
      // $('.modal-title').text('Add Status Karyawan'); // Set Title to Bootstrap modal title
    }
    ...
    {   
      ...
      var url;
      url = "{{ URL::route('editor.employee-status.store') }}";
      ...
      $.ajax({
        ...
        success: function(data) { 
          ...
          if ((data.errors)) {
            ...
            if (data.errors.employee_status_name) {
              $('.@yield('required')').removeClass('hidden');
              $('.@yield('required')').text(data.errors.employee_status_name);
            }
          } else {
   ...
   { 
    ...
    save_method = 'update';
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('[name="employee_status_name"]').val(data.employee_status_name);
          $('[name="status"]').val(data.status);
          $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
          $('.modal-title').text('Edit Status Karyawan'); // Set title to Bootstrap modal title
        },
    ...
    function delete_id(id, employee_status_name)
    {
      var employee_status_name = employee_status_name.bold();

      $.confirm({
        title: 'Confirm!',
        content: 'Are you sure to delete ' + employee_status_name + ' data?',
        type: 'red',
        typeAnimated: true,
        buttons: {
          cancel: {
