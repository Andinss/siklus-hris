  ...
  <div class="container-fluid">
      <div class="row bg-title">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
              <h4 class="page-title">@if(isset($reward)) Edit @else Tambah Baru @endif Teguran</h4>
          </div>
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
              <ol class="breadcrumb">
                  <li><a href="{{ url('/editor') }}">Halaman Utama</a></li>
                  <li class="active">@if(isset($reward)) Edit @else Tambah Baru @endif Teguran</li> 
              </ol>
          </div>
          <!-- /.col-lg-12 -->
      </div>
            ...
            <div class="panel panel-info">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        @if(isset($reward))
                        {!! Form::model($reward, array('route' => ['editor.reward.update', $reward->id], 'method' => 'PUT', 'files' => 'true'))!!}
                        @else
                        {!! Form::open(array('route' => 'editor.reward.store', 'files' => 'true'))!!}
                        @endif
                        {{ csrf_field() }}
                            <div class="form-body"> 
                                <section>
                                  <div class="row"> 
                                     <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          {{ Form::text('no_trans', old('no_trans'), array('class' => 'form-control', 'placeholder' => 'No Penghargaan', 'required' => 'true', 'id' => 'no_trans', 'disabled' => 'disabled')) }}
                                        </div>
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              ...
                                              {{ Form::text('date_trans', old('date_trans'), array('class' => 'form-control', 'required' => 'true', 'placeholder' => 'Tanggal Penghargaan', 'required' => 'true', 'id' => 'date_trans')) }}
                                          </div><!-- /.input group --> 
                                        </div>
                                      </div>   
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          {{ Form::select('employee_id', $employee_list, old('employee_id'), array('class' => 'form-control select2', 'placeholder' => 'Pilih Karyawan', 'required' => 'true', 'id' => 'employee_id', 'onchange' => 'RefreshData();')) }} 
                                        </div>
                                      </div>   
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          {{ Form::label('reward_type_id', 'Jenis Penghargaan *') }}
                                          {{ Form::select('reward_type_id', $reward_type_list, old('reward_type_id'), array('class' => 'form-control', 'required' => 'true', 'placeholder' => 'Select Jenis Penghargaan', 'id' => 'reward_type_id')) }}  
                                        </div>
                                      </div>   
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          {{ Form::text('description', old('description'), array('class' => 'form-control', 'placeholder' => 'Alasan', 'required' => 'true', 'id' => 'description')) }}
                                        </div>
                                      </div>  
                                  ...
                                  <a href="{{ URL::route('editor.reward.index') }}" class="btn btn-default pull-right btn-flat" style="margin-right: 10px"><i class="fa fa-close"></i> Tutup</a> 
                                </section>
                                </div>
                            {!! Form::close() !!}
                        </div>
         ...
         $.ajax({
          ...
          success: function(data) {  
            ...
            if ((data.errors)) { 
              ...
              window.location.href = "{{ URL::route('editor.reward.index') }}";
            }
          }, 
        }); 
       }
