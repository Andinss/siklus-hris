    ...
    <div class="modal-content">
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="modal-header">
         ...
         <h4 class="modal-title">Loan Type Form</h4>
       </div>
       <div class="modal-body"> 
         <div class="form-body">
            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
              <label class="control-label col-md-4 pull-left">Loan Type</label>
              <div class="col-md-8">
                <input name="loan_type_name" id="loan_type_name" class="form-control" type="text">
...
<script> 
  ...
  $(document).ready(function() {
      ...
      table = $('#dtTable').DataTable({ 
       ...
       ajax: "{{ URL::route('editor.loan-type.data') }}",
       columns: [  
       { data: 'action', name: 'action', orderable: false, searchable: false }, 
       { data: 'loan_type_name', name: 'loan_type_name' }, 
    ...
    function add()
    {
      ...
      // $('.modal-title').text('Add Loan Type'); // Set Title to Bootstrap modal title
    }
    ...
    {   
      ...
      var url;
      url = "{{ URL::route('editor.loan-type.store') }}";
      ...
      $.ajax({
        ...
        data: {
          ...
          'loan_type_name': $('#loan_type_name').val(), 
          'type': $('#type').val()
        },
        success: function(data) { 
          ...
          if ((data.errors)) {
            ...
            if (data.errors.loan_type_name) {
              $('.@yield('required')').removeClass('hidden');
              $('.@yield('required')').text(data.errors.loan_type_name);
            }
          } else {
   ...
   { 
    ...
    save_method = 'update';
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('[name="loan_type_name"]').val(data.loan_type_name);
          $('[name="type"]').val(data.type);
          $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
          $('.modal-title').text('Edit Loan Type'); // Set title to Bootstrap modal title
        },
    ...
    function delete_id(id, loan_type_name)
    {
      var loan_type_name = loan_type_name.bold();

      $.confirm({
        title: 'Confirm!',
        content: 'Are you sure to delete ' + loan_type_name + ' data?',
        type: 'red',
        typeAnimated: true,
        buttons: {
          cancel: {
