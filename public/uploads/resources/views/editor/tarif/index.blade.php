    ...
    <div class="modal-content">
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="modal-header">
         ...
         <h4 class="modal-title">Tarif Form</h4>
       </div>
       <div class="modal-body"> 
         <div class="form-body">
            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
              <label class="control-label col-md-4 pull-left">Tarif</label>
              <div class="col-md-8">
...
<script> 
  ...
  $(document).ready(function() {
      ...
      table = $('#dtTable').DataTable({ 
       ...
       ajax: "{{ URL::route('editor.tarif.data') }}",
       columns: [  
       { data: 'action', name: 'action', orderable: false, searchable: false }, 
       { data: 'tarif', name: 'tarif', render: $.fn.dataTable.render.number( ',', '.', 0, 'Rp ' ) }, 
    ...
    function add()
    {
      ...
      // $('.modal-title').text('Add Tarif'); // Set Title to Bootstrap modal title
    }
    ...
    {   
      ...
      var url;
      url = "{{ URL::route('editor.tarif.store') }}";
      ...
      $.ajax({
        ...
        success: function(data) { 
          ...
          if ((data.errors)) {
            ...
            if (data.errors.tarif) {
              $('.@yield('required')').removeClass('hidden');
              $('.@yield('required')').text(data.errors.tarif);
            }
          } else {
   ...
   { 
    ...
    function delete_id(id, tarif)
    {
      var tarif = tarif.bold();

      $.confirm({
        title: 'Confirm!',
        content: 'Are you sure to delete ' + tarif + ' data?',
        type: 'red',
        typeAnimated: true,
        buttons: {
          cancel: {
