...
<div class="modal fade" id="modal_form" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" style="width:40% !important">
    <div class="modal-content">
        {!! Form::open(array('route' => 'editor.cash-payment.store', 'class'=>'form-horizontal', 'files' => 'true', 'id'=>'form_floor'))!!}
        {{ csrf_field() }} 
...
<script> 
  ...
  $(document).ready(function() {
      ...
      table = $('#dtTable').DataTable({ 
       ...
       { data: 'cash_payment_no', name: 'cash_payment_no' },  
       { data: 'employee_name', name: 'employee_name' },  
       { data: 'coa_name', name: 'coa_name' },
       { data: 'cash_payment_date', name: 'cash_payment_date' },
