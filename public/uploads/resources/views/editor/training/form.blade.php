  ...
  <div class="container-fluid">
      <div class="row bg-title">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
              <h4 class="page-title">@if(isset($training)) Edit @else Tambah Baru @endif Pelatihan</h4>
          </div>
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
              <ol class="breadcrumb">
                  <li><a href="{{ url('/editor') }}">Dashboard</a></li>
                  <li class="active">@if(isset($training)) Edit @else Tambah Baru @endif Pelatihan</li> 
              </ol>
          </div>
          <!-- /.col-lg-12 -->
      </div>
            ...
            <div class="panel panel-info">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        @if(isset($training))
                        {!! Form::model($training, array('route' => ['editor.training.update', $training->id], 'method' => 'PUT', 'files' => 'true'))!!}
                        @else
                        {!! Form::open(array('route' => 'editor.training.store', 'files' => 'true'))!!}
                        @endif
                        {{ csrf_field() }}
                        <div class="form-body"> 
                            <section>
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::text('no_trans', old('no_trans'), array('class' => 'form-control', 'placeholder' => 'No Training *', 'required' => 'true', 'id' => 'no_trans', 'disabled' => 'disabled')) }}
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('date_trans', old('date_trans'), array('class' => 'form-control', 'placeholder' => 'Tanggal Training *', 'required' => 'true', 'id' => 'date_trans')) }}
                                    </div>
                                    <!-- /.input group --> 
                                  </div>
                                </div>    
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::select('education_type_id', $education_type_list, old('education_type_id'), array('class' => 'form-control', 'placeholder' => 'Pilih Jenis Pendidikan', 'id' => 'education_type_id', 'onchange' => 'diff_date()')) }}  
                                  </div>
                                </div>  
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::select('training_type_id', $training_type_list, old('training_type_id'), array('class' => 'form-control', 'placeholder' => 'Pilih Jenis Pelatihan', 'id' => 'training_type_id')) }}  
                                  </div>
                                </div>  
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::select('provider', $training_provider_list, old('provider'), array('class' => 'form-control', 'placeholder' => 'Select Pemberi Pelatihan', 'id' => 'provider')) }}  
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <div class="input-group">
                                          <span class="input-group-addon"><i class="fa fa-calendar"></i></span>  
                                          {{ Form::text('training_from', old('training_from'), array('class' => 'form-control', 'placeholder' => 'Dari Tanggal', 'required' => 'true', 'id' => 'training_from', 'onchange' => 'diff_date()')) }}
                                      </div>
                                      <!-- /.input group --> 
                                  </div>
                                </div>   
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>  
                                        {{ Form::text('training_to', old('training_to'), array('class' => 'form-control', 'placeholder' => 'Sampai Tanggal', 'required' => 'true', 'id' => 'training_to', 'onchange' => 'diff_date()')) }}
                                    </div>
                                    <!-- /.input group --> 
                                  </div>
                                </div>   
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::text('cost', old('cost'), array('class' => 'form-control', 'placeholder' => 'Biaya', 'required' => 'true', 'id' => 'cost')) }}
                                  </div>
                                </div> 
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::text('days', old('days'), array('class' => 'form-control', 'placeholder' => 'Hari', 'required' => 'true', 'id' => 'days')) }}
                                  </div>
                                </div> 
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::time('time_in', old('time_in'), array('class' => 'form-control', 'placeholder' => 'Jam Masuk', 'required' => 'true', 'id' => 'time_in')) }}
                                  </div>
                                </div> 
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::time('time_out', old('time_out'), array('class' => 'form-control', 'placeholder' => 'Jam Keluar', 'required' => 'true', 'id' => 'time_out')) }}
                                  </div>
                                </div> 
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    {{ Form::text('training_venue', old('training_venue'), array('class' => 'form-control', 'placeholder' => 'Lokasi', 'required' => 'true', 'id' => 'training_venue')) }}
                                  </div>
                                </div> 
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                  <div class="form-group">
                                    <button type="button" id="btnSave" onclick="savedetail();" class="btn btn-primary btn-flat"> <i class="fa fa-plus"></i> Tambah</button> 
                                  </div>
                                </div>

                                <div class="col-md-12">
                                  <div class="form-group">
                                    <table id="dtTablePar" class="display nowrap" cellspacing="0" width="100%">
                                      <thead>
                                        <tr> 
                                          <th>Aksi</th>
                                          <th>NIK</th>
                            ...
                            <div class="row"> 
                              <div class="col-md-12">
                                <div class="form-group"> 
                                  <button type="submit" id="btnsave" class="btn btn-success pull-right btn-flat"><i class="fa fa-check"></i> Simpan</button> 
                                  <a href="{{ URL::route('editor.training.index') }}" class="btn btn-default pull-right" style="margin-right: 5px"><i class="fa fa-close"></i> Tutup</a>
                                </div>
                              </div>
                            </div>
                            {!! Form::close() !!}
...
<script type="text/javascript">
  ...
  $('#training_from').datepicker({ format: 'dd-mm-yyyy' });
  $('#training_to').datepicker({ format: 'dd-mm-yyyy' });
