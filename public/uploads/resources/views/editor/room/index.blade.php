                                  ...
                                  <div :class="[{'data-table': true}, loading]">
                                    <vuetable
                                      ...
                                      <template slot="actions" scope="props">
                                        <div class="btn-group">
                                          <a class="btn btn-primary btn-flat btn-xs" @click="editRow(props.rowData)"><i class="ti-pencil-alt"></i> Edit</a>&nbsp;<a class="btn btn-danger btn-flat btn-xs" @click="deleteId(props.rowData)"><i class="ti-trash"></i> Delete</a>
													              </div>
                                      </template>
                                    </vuetable>
           ...
           confirm: {
            ...
            action: function () {
              console.log(this.$refs)
               $.ajax({
                url : "{{url('editor/user')}}" + `/delete/${rowData.id}`,
                type: "DELETE",
                data: {
