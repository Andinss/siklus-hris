    ...
    <div class="modal-content">
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="modal-header">
         ...
         <h4 class="modal-title">Form Jenis Gaji</h4>
       </div>
       <div class="modal-body"> 
         <div class="form-body">
            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
              <label class="control-label col-md-4 pull-left">Jenis Gaji</label>
              <div class="col-md-8">
                <input name="payroll_type_name" id="payroll_type_name" class="form-control" type="text">
...
<script> 
  ...
  $(document).ready(function() {
      ...
      table = $('#dtTable').DataTable({ 
       ...
       ajax: "{{ URL::route('editor.payroll-type.data') }}",
       columns: [  
    ...
    function add()
    {
      ...
      // $('.modal-title').text('Add Jenis Gaji'); // Set Title to Bootstrap modal title
    }
    ...
    {   
      ...
      var url;
      url = "{{ URL::route('editor.payroll-type.store') }}";
      ...
      $.ajax({
        ...
        data: {
          ...
          'payroll_type_name': $('#payroll_type_name').val(), 
          'status': $('#status').val()
        },
        success: function(data) { 
          ...
          if ((data.errors)) {
            ...
            if (data.errors.payroll_type_name) {
              $('.@yield('required')').removeClass('hidden');
              $('.@yield('required')').text(data.errors.payroll_type_name);
            }
          } else {
   ...
   { 
    ...
    save_method = 'update';
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('[name="payroll_type_name"]').val(data.payroll_type_name);
          $('[name="status"]').val(data.status);
          $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
          $('.modal-title').text('Edit Jenis Gaji'); // Set title to Bootstrap modal title
        },
    ...
    function delete_id(id, payroll_type_name)
    {
      var payroll_type_name = payroll_type_name.bold();

      $.confirm({
        title: 'Confirm!',
        content: 'Are you sure to delete ' + payroll_type_name + ' data?',
        type: 'red',
        typeAnimated: true,
        buttons: {
          cancel: {
