  ...
  <div class="modal-dialog" style="width:40% !important">
    <div class="modal-content">
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="modal-header">
         ...
         <h4 class="modal-title">Jenis Absensi Form</h4>
       </div>
       <div class="modal-body"> 
         <div class="form-body">
            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
              <label class="control-label col-md-4 pull-left">Jenis Absensi</label>
              <div class="col-md-8">
                <input name="absence_type_name" id="absence_type_name" class="form-control" type="text">
    ...
    <div class="modal-footer">
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <button type="button" id="btnSaveAdd" onClick="saveadd()" class="btn btn-primary pull-right">  <i class="fa fa-plus-square"></i> Simpan dan Tambah</button> 
      </div>  
    </div>
  </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
...
<script> 
  ...
  $(document).ready(function() {
      ...
      table = $('#dtTable').DataTable({ 
       ...
       ajax: "{{ URL::route('editor.absence-type.data') }}",
       columns: [  
    ...
    {   
      ...
      var url;
      url = "{{ URL::route('editor.absence-type.store') }}";
      ...
      $.ajax({
        ...
        data: {
          ...
          'absence_type_name': $('#absence_type_name').val(), 
          'status': $('#status').val()
        },
   ...
   { 
    ...
    save_method = 'update';
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('[name="absence_type_name"]').val(data.absence_type_name);
    ...
    function delete_id(id, absence_type_name)
    {
      var absence_type_name = absence_type_name.bold();

      $.confirm({
        title: 'Confirm!',
        content: 'Are you sure to delete ' + absence_type_name + ' data?',
        type: 'red',
        typeAnimated: true,
        buttons: {
          cancel: {
