            ...
            <div class="panel panel-info">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        @if(isset($cash_receive))
                        {!! Form::model($cash_receive, array('route' => ['editor.cash-receive.update', $cash_receive->id], 'method' => 'PUT', 'files' => 'true'))!!}
                        @else
                        {!! Form::open(array('route' => 'editor.cash_receive.store', 'files' => 'true'))!!}
                        @endif
                        {{ csrf_field() }}
                            <div class="form-body"> 
                                <section>
                                  <div class="row"> 
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('cash_receive_no', old('cash_receive_no'), array('class' => 'form-control', 'placeholder' => 'No Penerimaan', 'required' => 'true', 'id' => 'cash_receive_no', 'disabled' => 'disabled')) }}
                                        </div>
                                        <div class="form-group">
                                         {{ Form::label('employeeid', 'Tanggal Penerimaan') }}
                                         <div class="input-group">
                                          <span class="input-group-addon"><i class="fa fa-calendar"></i></span>   
                                           {{ Form::text('cash_receive_date', date("d-m-Y", strtotime($cash_receive->cash_receive_date)), array('class' => 'form-control', 'placeholder' => 'Tanggal Penerimaan', 'required' => 'true', 'id' => 'form_field_date', 'class' => 'form-control datepicker')) }}
                                          </div><!-- /.input group --> 
                                      </div> 
                                    </div>
                                    <!-- Coloumn 2-->   
                                    <div class="col-md-5"> 
                                     <div class="form-group">
                                        ...
                                        {{ Form::select('coa_id', $coa_list, old('coa_id'), array('class' => 'form-control', 'placeholder' => 'Pilih Debet', 'required' => 'true', 'id' => 'coa_id')) }} 
                                    </div>  
                                    <div class="form-group">
                                      <div class="form-group">
                                          {{ Form::label('employeeid', 'Jenis Pembayaran') }}
                                          {{ Form::select('pay_type_id', $pay_type__list, old('pay_type_id'), array('class' => 'form-control', 'placeholder' => 'Pilih Jenis Pembayaran', 'required' => 'true', 'id' => 'pay_type_id')) }} 
                                      </div>  
                                    </div>
                                    <div class="form-group" style="display: none">
                                      ...
                                      <div class="col-sm-9"> 
                                        @if($cash_receive->attachment != '')
                                          <a href="{{URL::to('/') .'/uploads/cashreceive/'. $cash_receive->attachment}}" target="_blank"><i class="fa fa-download"></i> Unduh </a>
                                          <br>
                                        @endif
                                ...
                                <hr>
                                 <div class="col-xs-12 col-md-12"> 
                                  ...
                                  <div class="col-md-3" style="margin-right: 5px">
                                    <div class="form-group">
                                      ...
                                      {{ Form::select('coa_id', $coa_list, old('coa_id'), array('class' => 'form-control', 'placeholder' => 'Pilih Akun Kredit', 'id' => 'account_d_id')) }} 
                                    </div> 
                                  </div>  
                                  ...
                                  <div class="col-md-1" style="margin-right: 5px">
                                    ...
                                    <div class="form-group">
                                     <label>Aksi</label><br/>
                                     <a href="#" onclick="savedetail();" type="button" class="btn btn-success" style="margin-left: 2px; margin-right: 2px" id="btn_add_detail"> <i class="fa fa-plus"></i> Tambah</a>
                                 ...
                                 <div>
                                  ...
                                  <div class="box-footer with-border">
                                    ...
                                    <a class="btn btn-primary btn-flat pull-right" name="open" style="margin-left: 2px; margin-right: 2px" onclick="cancel(id);" ><i class="fa fa-check"></i> Buka</a>
                                    @else
                                    ...
                                    @endif  
                                   <a href="{{ URL::route('editor.cash-receive.index', ['status' => '0']) }}" type="button" class="btn btn-default btn-flat pull-right" style="margin-left: 2px; margin-right: 2px"> <i class="fa fa-close"></i> keluar</a>
    ...
    save_method = 'post';  
      ...
      success: function(data) {  
          ...
          if ((data.errors)) { 
            ...
            window.location.href = "{{ URL::route('editor.cash-receive.index', ['status' => '0']) }}";
          }
        },
      })
    }
