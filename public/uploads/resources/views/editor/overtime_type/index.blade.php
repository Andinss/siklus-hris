    ...
    <div class="modal-content">
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="modal-header">
         ...
         <h4 class="modal-title">Form Jenis Lembur</h4>
       </div>
       <div class="modal-body"> 
         <div class="form-body">
            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
              <label class="control-label col-md-4 pull-left">Jenis Lembur</label>
              <div class="col-md-8">
                <input name="overtime_type_name" id="overtime_type_name" class="form-control" type="text">
...
<script> 
  ...
  $(document).ready(function() {
      ...
      table = $('#dtTable').DataTable({ 
       ...
       ajax: "{{ URL::route('editor.overtime-type.data') }}",
       columns: [  
       { data: 'action', name: 'action', orderable: false, searchable: false }, 
       { data: 'overtime_type_name', name: 'overtime_type_name' }, 
    ...
    function add()
    {
      ...
      // $('.modal-title').text('Add Jenis Lembur'); // Set Title to Bootstrap modal title
    }
    ...
    {   
      ...
      var url;
      url = "{{ URL::route('editor.overtime-type.store') }}";
      ...
      $.ajax({
        ...
        data: {
          ...
          'overtime_type_name': $('#overtime_type_name').val(), 
          'status': $('#status').val()
        },
        success: function(data) { 
          ...
          if ((data.errors)) {
            ...
            if (data.errors.overtime_type_name) {
              $('.@yield('required')').removeClass('hidden');
              $('.@yield('required')').text(data.errors.overtime_type_name);
            }
          } else {
   ...
   { 
    ...
    save_method = 'update';
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('[name="overtime_type_name"]').val(data.overtime_type_name);
          $('[name="status"]').val(data.status);
          $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
          $('.modal-title').text('Edit Jenis Lembur'); // Set title to Bootstrap modal title
        },
    ...
    function delete_id(id, overtime_type_name)
    {
      var overtime_type_name = overtime_type_name.bold();

      $.confirm({
        title: 'Confirm!',
        content: 'Are you sure to delete ' + overtime_type_name + ' data?',
        type: 'red',
        typeAnimated: true,
        buttons: {
          cancel: {
