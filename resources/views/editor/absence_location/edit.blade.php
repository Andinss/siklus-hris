                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('location_name', $absenceLocation->location_name, ['class' => 'form-control', 'placeholder' => 'Nama Lokasi', 'required' => 'true', 'id' => 'location_name']) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::textarea('address', $absenceLocation->location_address, ['class' => 'form-control', 'placeholder' => 'Alamat *', 'id' => 'address', 'required' => 'true']) }}
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('inputRadius', $absenceLocation->location_radius, ['class' => 'form-control', 'placeholder' => 'Isi dengan satuan meter', 'required' => 'true', 'id' => 'inputRadius']) }}
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        {{ Form::label('desc', 'Deskripsi (Opsional)') }}
                                                        {{ Form::textarea('desc', $absenceLocation->location_description, ['class' => 'form-control', 'placeholder' => 'Contoh: Lokasi Kantor', 'id' => 'desc', 'required' => 'true']) }}
                                                    </div>
                                                </div>
                                            </div>
                                            <hr class="border">
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            let employeeArray = @json($absenceLocation->employees);
            ...
            table = $('#dtTable').DataTable({
                ...
                data: @json($absenceLocation->employees),
                columns: [{
                        data: 'action',
                        name: 'action',
                        render: function(data, type, row) {
                            console.log(row);
                            return output = `
            <a href="javascript:void(0)" data-id="${row.id}" title="Hapus" class="btn btn-danger btn-xs mr-2 delete-btn" data-id="">
                <i class="ti-trash"></i> Hapus
                    ...
                    {
                        data: 'departement.department_name',
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    url: '/editor/absence-location/update/{{ $absenceLocation->id }}',
                    method: 'POST',
                    data: locationData,
                    success: function(response) {
