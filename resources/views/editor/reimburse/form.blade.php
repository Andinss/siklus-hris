                    ...
                    <div class="panel panel-info">
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                @if (isset($reimburse))
                                    {!! Form::model($reimburse, [
                                        'route' => ['editor.reimburse.update', $reimburse->id],
                                        'method' => 'PUT',
                                        'files' => 'true',
                                    ]) !!}
                                @else
                                    {!! Form::open(['route' => 'editor.cash_payment.store', 'files' => 'true']) !!}
                                @endif
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <section>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('no_trans', old('no_trans'), ['class' => 'form-control', 'placeholder' => 'No Klaim*', 'required' => 'true', 'id' => 'no_trans', 'disabled' => 'disabled']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        {{ Form::text('date_trans', old('date_trans'), ['class' => 'form-control', 'placeholder' => 'Tanggal Klaim*', 'required' => 'true', 'id' => 'date_trans', 'onclick' => 'saveheader();']) }}
                                                    </div><!-- /.input group -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('employee_id', $employee_list, old('employee_id'), ['class' => 'form-control select2', 'placeholder' => 'Pilih Karyawan *', 'id' => 'employee_id', 'required' => 'true', 'onchange' => 'RefreshData();']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('reimburse_type_id', 'Jenis Klaim') }}
                                                    {{ Form::select('reimburse_type_id', $reimburse_type_list, old('reimburse_type_id'), ['class' => 'form-control', 'placeholder' => 'Pilih Jenis Klaim', 'id' => 'reimburse_type_id', 'onchange' => 'RefreshData();']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('period', 'Periode') }}
                                                    {{ Form::select('period_id', $period_list, old('period_id'), ['class' => 'form-control', 'placeholder' => 'Pilih Periode', 'id' => 'period_id', 'onchange' => 'RefreshData();']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <hr>
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-4" style="margin-right: 5px">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('description', old('description'), ['class' => 'form-control', 'placeholder' => 'Ketarangan', 'id' => 'description', 'onclick' => 'saveheader();']) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3" style="display: none;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                    class="fa fa-calendar"></i></span>
                                                            {{ Form::text('dateclaim', old('dateclaim'), ['class' => 'form-control', 'placeholder' => 'Tanggal*', 'id' => 'dateclaim', 'onclick' => 'saveheader();']) }}
                                                        </div><!-- /.input group -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2" style="display: none;">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('no_ref', old('no_ref'), ['class' => 'form-control', 'placeholder' => 'No Referensi*', 'id' => 'no_ref', 'onclick' => 'saveheader();']) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>Jumlah *</label>
                                                        {{ Form::text('quantity', old('quantity'), ['class' => 'form-control', 'placeholder' => 'Jumlah', 'id' => 'quantity', 'onclick' => 'saveheader();']) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2" style="margin-right: 5px">
                                                    <div class="form-group">
                                                        <label>Total *</label>
                                                        {{ Form::text('amount', old('amount'), ['class' => 'form-control', 'placeholder' => 'Total', 'id' => 'amount', 'onclick' => 'saveheader();']) }}
                                                    </div>
                                                </div>
                                        ...
                                        <div class="box-footer with-border">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea style="height: 40px !important" class="form-control" id="remark" name="remark" onchange="saveheader();"
                                                            required> {{ $reimburse->remark }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <a href="{{ URL::route('editor.reimburse.index') }}" type="button"
                                                class="btn btn-default btn-flat pull-right"
                                                style="margin-left: 2px; margin-right: 2px"> <i class="fa fa-close"></i>
                                                Close</a>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function saveheader() {
            ...
            $.ajax({
                url: '{{ url("reimburse/saveheader/$reimburse->id") }}',
                type: "PUT",
                data: {
                    '_token': $('input[name=_token]').val(),
                    'reimbursetypeid': $('#reimbursetypeid').val(),
        ...
        function savedetail() {
            ...
            if (employeeid == '') {
                ...
                //Ajax Load data from ajax
                $.ajax({
                    url: '{{ url("editor/reimburse/savedetail/$reimburse->id") }}',
                    type: "PUT",
                    data: {
                        '_token': $('input[name=_token]').val(),
                        ...
                        action: function() {
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    toastr.success('Successfully genareted data!', 'Success Alert',
                                        options);
                                    reload_table();
                                    location.reload();
                                },
