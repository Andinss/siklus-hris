                                ...
                                <div class="col-sm-8 col-md-8 col-lg-8">
                                    <div class="button-box">
                                        <a href="{{ URL::route('editor.user.create') }}" type="button"
                                            class="btn btn-primary btn-flat"> <i class="fa fa-sticky-note-o"></i> Tambah
                                            Baru</a>
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    ...
                                    <div :class="[{ 'data-table': true }, loading]">
                                        <vuetable ref="vuetable" api-url="{{ URL::route('editor.action.data') }}"
                                            ...
                                            <template slot="actions" scope="props">
                                                <div class="btn-group">
                                                    <a class="btn btn-primary btn-flat btn-xs"
                                                        ...
                                                        @click="deleteId(props.rowData)"><i class="ti-trash"></i> Hapus</a>
                                                </div>
                                            </template>
