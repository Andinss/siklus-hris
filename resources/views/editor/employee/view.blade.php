                                        ...
                                        <address>
                                            @if (isset($employee->image))
                                                <img style="width: 100% !important"
                                                    ...
                                                    alt="home" />
                                            @else
                                                <img src="{{ asset('assets/plugins') }}/images/employee_icon.png"
                                                    alt="home" />
                                                <p style="color: red; font-size: 10px"><i>
                                                        <center> *Tidak ada foto karyawan</center>
                                                    </i></p>
                                            @endif

                                            <h3> &nbsp;<b class="text-danger">
                                                    <center>{{ $employee->employee_name }}</center>
                                                </b></h3>
                                        </address>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="pull-left text-left">
                                        <address>
                                            ...
                                            <p><b>Tanggal Lahir :</b> {{ date('d-m-Y', strtotime($employee->date_birth)) }}
                                            </p>
                                            <p><b>Tanggal Kontrak :</b>
                                                {{ date('d-m-Y', strtotime($employee->term_date)) }}</p>
                                            <p><b>Tanggal Pensiun :</b>
                                                {{ date('d-m-Y', strtotime($employee->pension_date)) }}</p>
