                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" style="width: 100%;" name="item_category_id"
                                            id="item_category_id">
                                            @foreach ($item_category as $item_categorys)
                                                <option value="{{ $item_categorys->id }}">
                                                    {{ $item_categorys->item_category_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" style="width: 100%;" name="container_id"
                                            id="container_id">
                                            @foreach ($container as $containers)
                                                <option value="{{ $containers->id }}">{{ $containers->container_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
