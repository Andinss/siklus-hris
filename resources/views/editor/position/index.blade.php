                    ...
                    <div class="modal-body">
                        <div class="form-body">
                            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                <label class="control-label col-md-4 pull-left">Nama Jabatan</label>
                                <div class="col-md-8">
                                    <input name="position_name" id="position_name" class="form-control" type="text">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dtTable').DataTable({
                ...
                ajax: "{{ URL::route('editor.position.data') }}",
                columns: [{
                        data: 'action',
                        name: 'action',
                        orderable: false,
        ...
        function save() {
            ...
            var url;
            url = "{{ URL::route('editor.position.store') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        if (data.errors.position_name) {
                            $('.@yield('required')').removeClass('hidden');
                            $('.@yield('required')').text(data.errors.position_name);
                        }
                    } else {
        ...
        function delete_id(id, position_name) {
            var position_name = position_name.bold();

            $.confirm({
                title: 'Confirm!',
                content: 'Are you sure to delete ' + position_name + ' data?',
                type: 'red',
                typeAnimated: true,
                buttons: {
                    cancel: {
