                                     ...
                                     <div class="page">
                                         ...
                                         <div class="detail">
                                             <table border="0" style="width: 100mm">
                                                 <tr>
                                                     <td><b>SALDO AKHIR {{ strtoupper($datafilterbefore->monthname) }}
                                                             {{ $year }}</b></td>
                                                     <td>:</td>
                                                 ...
                                                 <tr>
                                                     <td><b>TOTAL PENERIMAAN {{ strtoupper($datafilter->monthname) }}
                                                             {{ $year }}</b></td>
                                                     <td>:</td>
                                                     @if (isset($datareceive->amount))
                                                 ...
                                                 <tr>
                                                     <td><b>TOTAL PENGELUARAN {{ strtoupper($datafilter->monthname) }}
                                                             {{ $year }}</b></td>
                                                     <td>:</td>
                                                     <td>@php echo number_format($payment->amount) @endphp</td>
                                                 </tr>
                                                 <tr>
                                                     <td><b>SALDO PER {{ strtoupper($datafilter->monthname) }}
                                                             {{ $year }}</b></td>
                                                     <td>:</td>
                                             ...
                                             <table border="0">
                                                 ...
                                                 <tbody id="selected_items">
                                                     ...
                                                     @foreach ($itemdata as $itemdatas)
                                                         ...
                                                         <td>
                                                             <p align="right">{{ number_format($itemdatas->debt) }}</p>
                                                         </td>
                                                         <td>
                                                             <p align="right">{{ number_format($itemdatas->credit) }}</p>
                                                         </td>
                                                         <td>
                                                             <p align="right">@php echo number_format($balance); @endphp </p>
                                                         </td>
                                                         {{-- <hr> --}}
                                                         </tr>
                                                     @endforeach
