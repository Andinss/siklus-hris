                                ...
                                <tbody>
                                    @foreach ($role->user_role as $key => $user_role)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="{{ URL::route('editor.user.detail', [$user_role->user->id]) }}"
                                                    class="btn btn-default btn-sm"><i class="fa fa-search"></i></a>
                                                <a href="{{ URL::route('editor.user.edit', [$user_role->user->id]) }}"
                                                    class="btn btn-default btn-sm"><i class="fa fa-pencil"></i></a>
                                                <a href="{{ URL::route('editor.user.delete', [$user_role->user->id]) }}"
