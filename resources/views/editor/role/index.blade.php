                ...
                <div class="col-md-10">
                    <div class="x_panel">
                        <h2>
                            ...
                            <a href="{{ URL::route('editor.role.create') }}" class="btn btn-default btn-lg pull-right"><i
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <div class="col-md-2 nopadding">
                                                    <a href="{{ URL::route('editor.role.detail', [$role->id]) }}"
                                                        class="btn btn-default btn-sm"><i class="fa fa-search"></i></a>
                                                </div>
                                                <div class="col-md-2 nopadding">
                                                    {!! Form::open(['route' => ['editor.role.delete', $role->id], 'method' => 'delete']) !!}
                                                    {{ csrf_field() }}
