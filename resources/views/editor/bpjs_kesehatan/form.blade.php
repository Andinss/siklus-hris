...
@section('title', 'Formulir Kalkulasi BPJS Kesehatan')
                    ...
                    <div class="panel panel-info">
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                <form action="{{ URL::route('editor.bpjs-kesehatan.store') }}" id="formHitungBpjs"
                                    method="POST">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row mb-3">
                                            <!-- <div class="col-6">
                                              ...
                                              {{ Form::text('basic', old('basic'), ['class' => 'form-control', 'placeholder' => 'Rp', 'id' => 'dasar_upah', 'required']) }}
                                            </div> -->
                                            <div class="col-6">
                                                {{ Form::label('schema_name', 'Nama Skema Perhitungan BPJS Kesehatan', ['class' => 'mb-0 mt-3']) }}
                                                {{ Form::text('schema_name', old('schema_name'), ['class' => 'form-control', 'placeholder' => 'Contoh: TK Golongan 1/ Staff', 'id' => 'perhitungan_upah', 'required']) }}
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" name="simpan_kalkulasi" id="simpan_kalkulasi"
                                            ...
                                            Skema</button>
                                        <a href="{{ URL::route('editor.bpjs-kesehatan.index') }}"
        ...
        const calculate_bpjs_auto = () => {
            ...
            for (let i = 0; i < tbBPJS.length; i++) {
                if (upah == 0 || $("#dasar_upah").val() == '') {
                    alert("Maaf, masukan nominal dasar upah dengan benar");
                } else {
