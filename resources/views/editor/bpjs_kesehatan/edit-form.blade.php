...
@section('title', 'Formulit kalkulasi BPJS Kesehatan')
                    ...
                    <div class="panel panel-info">
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                <form action="{{ URL::route('editor.bpjs-tk.update', $bpjs->id) }}" id="formHitungBpjs"
                                    method="POST">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row mb-3">
                                            <!-- <div class="col-6">
                                              ...
                                              {{ Form::text('basic', old('basic', $bpjs->basic), ['class' => 'form-control', 'placeholder' => 'Rp', 'id' => 'basic', 'autocomplete' => 'off', 'required']) }}
                                            </div> -->
                                            <div class="col-6">
                                                {{ Form::label('schema_name', 'Nama Skema Perhitungan BPJS TK', ['class' => 'mb-0 mt-3']) }}
                                                {{ Form::text('schema_name', old('schema_name', $bpjs->schema_name), ['class' => 'form-control', 'placeholder' => 'Contoh: TK Golongan 1/ Staff', 'id' => 'schema_name', 'autocomplete' => 'off', 'required']) }}
                                            </div>
                                        </div>
                                            ...
                                            <tbody id="dtBPJSBody">
                                                ...
                                                <td>
                                                  {{ Form::text("bpjs_ditanggung_karyawan_rp[$key]", old('nominal_employee_guarantee', $row->nominal_employee_guarantee), ['class' => 'form-control bpjs_ditanggung_karyawan_rp', 'placeholder' => 'Rp', 'id' => "bpjs_ditanggung_karyawan_rp_$key", 'readonly' => true]) }}
                                                        ...
                                                        <td>
                                                            <a href="#" role="button"
                                                                class="btn btn-flat btn-default mb-0">#</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ Form::text('bpjs_sum_perusahaan_percent', old('bpjs_sum_perusahaan_percent', $bpjs->total_percentage_company), ['class' => 'form-control', 'placeholder' => '%', 'id' => 'bpjs_sum_perusahaan_percent', 'required', 'autocomplete' => 'off']) }}
                                                    </td>
                                                    <td>
                                                        {{ Form::text('bpjs_sum_karyawan_percent', old('bpjs_sum_karyawan_percent', $bpjs->total_percentage_employee), ['class' => 'form-control', 'placeholder' => '%', 'id' => 'bpjs_sum_karyawan_percent', 'required', 'autocomplete' => 'off']) }}
                                                    </td>
                                                    <!-- <td>
                                                  {{ Form::text('bpjs_sum_perusahaan', old('bpjs_sum_perusahaan', $bpjs->total_company_guarantee), ['class' => 'form-control', 'placeholder' => 'Rp', 'id' => 'bpjs_sum_perusahaan', 'readonly' => true]) }}
                                                </td>
                                                <td>
                                                  {{ Form::text('bpjs_sum_karyawan', old('bpjs_sum_karyawan', $bpjs->total_employee_guarantee), ['class' => 'form-control', 'placeholder' => 'Rp', 'id' => 'bpjs_sum_karyawan', 'readonly' => true]) }}
                                                </td> -->
                                                    <td>
                                                        <div></div>
                                                    </td>
                                                ...
                                                <td colspan="3">
                                                  {{ Form::text('bpjs_total', old('total_bpjstk', $bpjs->total_bpjs_kesehatan), ['class' => 'form-control', 'placeholder' => 'Total Iuran (Rp)', 'id' => 'bpjs_total', 'required']) }}
