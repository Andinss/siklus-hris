                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                                ...
                                <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input name="holiday_date" id="holiday_date" class="form-control"
                                                type="date">
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                    <label class="control-label col-md-4 pull-left">Kode Shift yang dikecualikan</label>
                                    <div class="col-md-8">
                                        <select class="form-control" name="shift_id" id="shift_id">
                                            <option value="">-- Tidak ada --</option>
                                            @foreach ($shift_lists as $shift_list)
                                                <option value="{{ $shift_list->id }}"
                                                    @if ($shift_list->absence_type_id == 9) style="background-color: #e06b6b" @endif>
                                                    {{ $shift_list->shift_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('[name="shift_id"]').val(data.exception_shift_id);
