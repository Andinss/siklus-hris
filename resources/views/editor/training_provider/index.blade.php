                            ...
                            <div class="modal-body">
                                <div class="form-body">
                                    <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                        ...
                                        <div class="col-md-8">
                                            <input name="training_provider_name" id="training_provider_name"
                            ...
                            <div class="modal-body">
                                <div class="form-body">
                                    <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                        ...
                                        <div class="col-md-8">
                                            <input name="provider_type" id="provider_type" class="form-control"
                                                type="text">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body">
                                <div class="form-body">
                                    <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                        ...
                                        <div class="col-md-8">
                                            <input name="instructor" id="instructor" class="form-control"
                                                type="text">
                                        </div>
                                    </div>
                                </div>
