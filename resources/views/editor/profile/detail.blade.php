                                ...
                                <div class="table-responsive">
                                    <div class="x_panel">
                                        <h2>
                                            ...
                                            <a href="{{ URL::route('editor.profile.edit') }}"
                                                class="btn btn-default pull-right btn-flat btn-lg"><i
                                                        ...
                                                        <td>
                                                            @if (Auth::user()->filename == null)
                                                                <br /><a class="fancybox" rel="group"
                                                                    href="{{ asset('uploads') }}/user/placeholder.png"><img
                                                                        src="{{ asset('uploads') }}/user/thumbnail/placeholder.png"
                                                                        class="img-thumbnail img-responsive" /></a><br />
                                                            @else
                                                                <br /><a class="fancybox" rel="group"
                                                                    href="{{ asset('uploads') }}/user/{{ Auth::user()->username }}/thumbnail/{{ Auth::user()->filename }}"><img
