                ...
                <div class="col-md-5">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::model($profile, [
                                'route' => ['editor.profile.updatemobile', $profile->customer_id],
                                'method' => 'PUT',
                                'files' => 'true',
                            ]) !!}
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="telf1" class="form-control" name="telf1" id="telf1"
                                        value="{{ old('telf1', $profile->telf1) }}" placeholder="No HP*" required>
                                </div><br>
                                ...
                                <button type="submit" class="btn btn-success pull-right btn-lg btn-flat"><i
