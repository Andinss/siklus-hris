    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dtTable').DataTable({
                ...
                ajax: "{{ URL::route('editor.shift-group.data') }}",
                columns: [{
                        data: 'action',
                        name: 'action',
                        orderable: false,
        ...
        function save() {
            ...
            var url;
            url = "{{ URL::route('editor.shift-group.store') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        if (data.errors.shift_group_name) {
                            $('.@yield('required')').removeClass('hidden');
                            $('.@yield('required')').text(data.errors.shift_group_name);
                        }
                    } else {
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('[name="shift_group_name"]').val(data.shift_group_name);
        ...
        function delete_id(id, shift_group_name) {
            var shift_group_name = shift_group_name.bold();

            $.confirm({
                title: 'Confirm!',
                content: 'Are you sure to delete ' + shift_group_name + ' data?',
                type: 'red',
                typeAnimated: true,
                buttons: {
                    cancel: {
