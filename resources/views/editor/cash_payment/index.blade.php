                            ...
                            <div class="white-box">
                                <div class="button-box">
                                    <button type="button" onClick="add()"
                                        class="fcbtn btn btn-primary btn-outline btn-1b waves-effect"><i
                                            class="fa fa-sticky-note-o"></i>&nbsp;&nbsp;Tambah Baru</button>
    ...
    <div class="modal fade" id="modal_form" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" style="width:40% !important">
            <div class="modal-content">
                {!! Form::open([
                    'route' => 'editor.cash-payment.store',
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Pilih Kode Pengeluaran Kas?</h4>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="form-body">
                            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="code_trans" id="code_trans"
                                        placeholder="Transaction Code">
                                        <option value="CASHOUT">Pengeluaran Kas</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dtTable').DataTable({
                ...
                ajax: "{{ URL::route('editor.cash-payment.data') }}",
                columns: [{
                        data: 'action',
                        name: 'action',
                        orderable: false,
                    ...
                    {
                        data: 'cash_payment_no',
                        name: 'cash_payment_no'
                    },
                    {
                        data: 'employee_name',
                        name: 'employee_name'
        ...
        function add() {
            ...
            $('.modal-title').text('Tambah Pengeluaran Kas?'); // Set Title to Bootstrap modal title
        }
