                    ...
                    <div class="panel panel-info">
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                @if (isset($cash_payment))
                                    {!! Form::model($cash_payment, [
                                        'route' => ['editor.cash-payment.update', $cash_payment->id],
                                        'method' => 'PUT',
                                        'files' => 'true',
                                    ]) !!}
                                @else
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('cash_payment_no', old('cash_payment_no'), ['class' => 'form-control', 'placeholder' => 'No Pengeluaran*', 'required' => 'true', 'id' => 'cash_payment_no', 'disabled' => 'disabled']) }}
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        {{ Form::text('cash_payment_date', date('d-m-Y', strtotime($cash_payment->cash_payment_date)), ['class' => 'form-control', 'placeholder' => 'Date Trans*', 'required' => 'true', 'id' => 'form_field_date', 'class' => 'form-control datepicker']) }}
                                                    </div><!-- /.input group -->
                                                </div>
                                            </div>
                                            <!-- Coloumn 2-->
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('coa_id', $coa_list, old('coa_id'), ['class' => 'form-control', 'placeholder' => 'Select Akun Kredit', 'required' => 'true', 'id' => 'coa_id']) }}
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        {{ Form::label('employeeid', 'Jenis Pembayaran') }}
                                                        {{ Form::select('pay_type_id', $pay_type_list, old('pay_type_id'), ['class' => 'form-control', 'placeholder' => 'Select Jenis Pembayaran', 'required' => 'true', 'id' => 'pay_type_id']) }}
                                                    </div>
                                                </div>
                                                <div class="form-group" style="display: none">
                                                    ...
                                                    <div class="col-sm-9">
                                                        @if ($cash_payment->attachment != '')
                                                            <a href="{{ URL::to('/') . '/uploads/cashpayment/' . $cash_payment->attachment }}"
                                        ...
                                        <div class="col-xs-12 col-md-12">
                                            ...
                                            <div class="col-md-3" style="margin-right: 5px">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('coa_id', $coa_list, old('coa_id'), ['class' => 'form-control', 'placeholder' => 'Pilih Akun Debit', 'id' => 'account_d_id']) }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1" style="margin-right: 5px">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a href="#" onclick="savedetail();" type="button"
                                                        ...
                                                        id="btn_add_detail"> <i class="fa fa-plus"></i> Add</a>
                                            ...
                                            <div class="box-footer with-border">
                                                ...
                                                @endif
                                                <a href="{{ URL::route('editor.cash-payment.index', ['status' => '0']) }}"
                    ...
                    success: function(data) {
                        ...
                        if ((data.errors)) {
                            ...
                            window.location.href =
                                "{{ URL::route('editor.cash-payment.index', ['status' => '0']) }}";
                        }
                    },
                })
            }
