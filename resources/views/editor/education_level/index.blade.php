            ...
            <div class="modal-content">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Education Level Form</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-body">
                            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                <label class="control-label col-md-4 pull-left">Education Level</label>
                                <div class="col-md-8">
                                    <input name="education_level_name" id="education_level_name" class="form-control"
                                        type="text">
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <button type="button" id="btnSave" class="btn btn-primary pull-right" style="margin-left: 5px">
                            <i class="fa fa-save"></i> Save & Close</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dtTable').DataTable({
                ...
                ajax: "{{ URL::route('editor.education-level.data') }}",
                columns: [{
                        data: 'action',
                        name: 'action',
                        orderable: false,
        ...
        function save() {
            ...
            var url;
            url = "{{ URL::route('editor.education-level.store') }}";
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'education_level_name': $('#education_level_name').val(),
                    'status': $('#status').val()
                },
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        if (data.errors.education_level_name) {
                            $('.@yield('required')').removeClass('hidden');
                            $('.@yield('required')').text(data.errors.education_level_name);
                        }
                    } else {
        ...
        function edit(id) {
            ...
            $.ajax({
                url: 'education-level/edit/' + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {

                    $('[name="id_key"]').val(data.id);
                    $('[name="education_level_name"]').val(data.education_level_name);
                    $('[name="status"]').val(data.status);
                    $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                    $('.modal-title').text('Edit Education Level'); // Set title to Bootstrap modal title
                },
        ...
        function delete_id(id, education_level_name) {
            var education_level_name = education_level_name.bold();

            $.confirm({
                title: 'Confirm!',
                content: 'Are you sure to delete ' + education_level_name + ' data?',
                type: 'red',
                typeAnimated: true,
                buttons: {
                    cancel: {
