                            ...
                            <div class="panel-body">
                                @if (isset($reimburse))
                                    {!! Form::model($reimburse, [
                                        'route' => ['editor.reimburse-approval.update', $reimburse->id],
                                        'method' => 'PUT',
                                        'files' => 'true',
                                    ]) !!}
                                @else
                                ...
                                <div class="white-box printableArea">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="pull-left">
                                                <address>
                                                    <h3> &nbsp;<b class="text-danger">{{ $reimburse->employee_name }}</b>
                                                    </h3>
                                                    <p class="text-muted m-l-5">NIK {{ $reimburse->nik }}
                                                        <br />Position {{ $reimburse->position_name }}
                                                        <br />Department {{ $reimburse->department_name }}
                                                    </p>
                                                </address>
                                            </div>
                                            <div class="pull-right text-right">
                                                <address>
                                                    ...
                                                    <p><b>Tanggal :</b> <i class="fa fa-calendar"></i>
                                                        {{ $reimburse->date_trans }}</p>
                                                </address>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($reimburse_detail as $reimburse_details)
                                                            <tr>
                                                                ...
                                                                <td class="text-right">{{ $reimburse_details->quantity }}
                                                                </td>
                                                                <td class="text-right">
                                                                    {{ number_format($reimburse_details->amount, 0) }}
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="col-md-12">
                                            <div class="pull-right m-t-30 text-right">
                                                <p><b>Total : </b>@php echo number_format($total,0); @endphp</p>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="text-right">
                                                @if ($reimburse->status == 0)
                                                    <button class="btn btn-danger" type="submit"> Setujui </button>
                                                @endif
                                                <button id="print" class="btn btn-default btn-outline" type="button">
                                                    <span><i class="fa fa-print"></i> Cetak</span> </button>
                                            </div>
                                        </div>
                                    </div>
                                    {!! Form::close() !!}
