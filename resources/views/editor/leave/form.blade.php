                    ...
                    <div class="panel panel-info">
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                @if (isset($leave))
                                    {!! Form::model($leave, ['route' => ['editor.leave.update', $leave->id], 'method' => 'PUT', 'files' => 'true']) !!}
                                @else
                                    {!! Form::open(['route' => 'editor.leave.store', 'files' => 'true']) !!}
                                @endif
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <section>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('no_trans', old('no_trans'), ['class' => 'form-control', 'placeholder' => 'No Cuti *', 'required' => 'true', 'id' => 'no_trans', 'disabled' => 'disabled']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        {{ Form::text('date_trans', old('date_trans'), ['class' => 'form-control', 'placeholder' => 'Tanggal Cuti *', 'required' => 'true']) }}
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('absence_type_id', $absence_type_list, old('absence_type_id'), ['class' => 'form-control', 'placeholder' => 'Pilih Jenis Ijin', 'id' => 'absence_type_id', 'onchange' => 'setdisease()']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="fa fa-calendar"></i></span>
                                                        {{ Form::text('leave_from', old('leave_from'), ['class' => 'form-control', 'placeholder' => 'Dari Tanggal*', 'required' => 'true', 'id' => 'leave_from']) }}
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="fa fa-calendar"></i></span>
                                                        {{ Form::text('leave_to', old('leave_to'), ['class' => 'form-control', 'placeholder' => 'Sampai Tanggal*', 'required' => 'true', 'id' => 'leave_to']) }}
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                            </div>
                                        ...
                                        <a href="{{ URL::route('editor.leave.index') }}"
