                            ...
                            <div class="row">
                                <div class="col-sm-8 col-md-8 col-lg-8">
                                    <div class="button-box">
                                        <a href="{{ URL::route('editor.user.create') }}" type="button"
                                            class="btn btn-primary btn-flat"> <i class="fa fa-sticky-note-o"></i> Add
                                            New</a>
                                        <button onClick="history.back()" type="button" class="btn btn-primary btn-flat"> <i
                                                class="fa fa-undo"></i> Back</button>
                                        <button @click="refreshTable()" type="button" class="btn btn-success btn-flat"> <i
                                                class="fa fa-refresh"></i> Refresh</button>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="btn-group pull-right">
                                        <input type="text" class="form-control" v-model="searchFor" placeholder="search"
                                            @keyup.enter="setFilter" />
                                        <button class="btn btn-warning btn-flat" @click="resetFilter"><i
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <div :class="[{ 'data-table': true }, loading]">
                                        <vuetable ref="vuetable" api-url="{{ URL::route('api.user.data') }}"
                                            ...
                                            <template slot="actions" scope="props">
                                                <div class="btn-group">
                                                    <a class="btn btn-primary btn-flat btn-xs"
                                                        @click="editRow(props.rowData)"><i class="ti-pencil-alt"></i>
                                                        Edit</a>&nbsp;<a class="btn btn-danger btn-flat btn-xs"
                                                        @click="deleteId(props.rowData)"><i class="ti-trash"></i> Delete</a>
                                                </div>
                                            </template>
                                        </vuetable>
    ...
    <script>
        ...
        var vm = new Vue({
            ...
            methods: {
                ...
                editRow(rowData) {
                    location.href = "{{ url('editor/user') }}" + `/${rowData.id}/edit`
                },

                deleteRow(rowData) {
                    delete_id(`${rowData.id}`, `${rowData.username}`);
                },
