            ...
            <div class="modal-content">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Form PTKP</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-body">
                            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                <label class="control-label col-md-4 pull-left">Status Pajak</label>
                                <div class="col-md-8">
                                    <input name="tax_status" id="tax_status" class="form-control" type="text">
                                    <small class="@yield('required') hidden alert-danger"></small>
                                </div>
                            </div>
                            <div class="col-lg-12" class="col-md-12" class="col-sm-12">
                                <label class="control-label col-md-4 pull-left">Nama PTKP</label>
                                <div class="col-md-8">
                                    <input name="ptkp" id="ptkp" class="form-control" type="text">
                                    <small class="@yield('required') hidden alert-danger"></small>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dtTable').DataTable({
                ...
                ajax: "{{ URL::route('editor.ptkp.data') }}",
                columns: [{
                        data: 'action',
                        name: 'action',
                        orderable: false,
        ...
        function add() {
            ...
            // $('.modal-title').text('Add PTKP'); // Set Title to Bootstrap modal title
        }
        ...
        function save() {
            ...
            var url;
            url = "{{ URL::route('editor.ptkp.store') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        if (data.errors.tax_status) {
                            $('.@yield('required')').removeClass('hidden');
                            $('.@yield('required')').text(data.errors.tax_status);
                        }
                    } else {
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('[name="tax_status"]').val(data.tax_status);
                    $('[name="ptkp"]').val(data.ptkp);
                    $('[name="status"]').val(data.status);
                    $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                    $('.modal-title').text('Edit PTKP'); // Set title to Bootstrap modal title
                },
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        if (data.errors.tax_status) {
                            $('.@yield('required')').removeClass('hidden');
                            $('.@yield('required')').text(data.errors.tax_status);
                            $('.@yield('required')').text(data.errors.ptkp);
                        }
                    } else {
                        var options = {
                            "positionClass": "toast-bottom-right",
        ...
        function delete_id(id, tax_status) {
            var tax_status = tax_status.bold();

            $.confirm({
                title: 'Confirm!',
                content: 'Are you sure to delete ' + tax_status + ' data?',
                type: 'red',
                typeAnimated: true,
                buttons: {
                    cancel: {
