                            ...
                            <div class="row">
                                <div class="col-sm-8 col-md-8 col-lg-8">
                                    <div class="button-box">
                                        <a href="{{ URL::route('editor.privilege.create') }}" type="button"
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <div :class="[{ 'data-table': true }, loading]">
                                        <vuetable ref="vuetable" api-url="{{ URL::route('api.privilege.data') }}"
                                            ...
                                            <template slot="actions" scope="props">
                                                <div class="btn-group">
                                                    <a class="btn btn-primary btn-xs" @click="editRow(props.rowData)"><i
