        ...
        <ul class="sidebar-menu" style="margin-top:45px">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ URL::route('editor.revenue.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Outstanding</a></li>
                    <li><a href="{{ URL::route('editor.revenue.bank') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Bank</a></li>
                </ul>
                @actionEnd
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ URL::route('editor.cashbond.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Outstanding</a></li>
                    @actionEnd
                    @actionStart('cashbondbank', 'read')
                    <li><a href="{{ URL::route('editor.cashbondbank.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Bank</a></li>
                    @actionEnd
                </ul>
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ URL::route('editor.invoice.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Utilization</a></li>
                    @actionEnd
                    @actionStart('invoicedirect', 'read')
                    <li><a href="{{ URL::route('editor.invoicedirect.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Consumable</a></li>
                    @actionEnd
                </ul>
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ URL::route('editor.item_central.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Outstanding</a></li>
                    @actionEnd
                    @actionStart('item_central_bank', 'read')
                    <li><a href="{{ URL::route('editor.item_central_bank.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Bank</a></li>
                    @actionEnd
                </ul>
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="{{ URL::route('editor.cashbond_payroll.index') }}"><i
                                class="fa fa-dollar yellow-sumobo"></i>&nbsp;&nbsp;Cashbond
                    ...
                    <li>
                        <a href="{{ URL::route('editor.payroll.index') }}"><i
                                class="fa fa-list-ul yellow-sumobo"></i>&nbsp;&nbsp;Payroll List
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ URL::route('editor.user.index') }}"><i
                                class="fa fa-user-circle yellow-sumobo"></i>&nbsp;&nbsp;User List</a></li>
                    @actionEnd

                    @actionStart('module', 'read')
                    <li><a href="{{ URL::route('editor.module.index') }}"><i
                                class="fa fa-cog yellow-sumobo"></i>&nbsp;&nbsp;Module List</a></li>
                    @actionEnd

                    @actionStart('action', 'read')
                    <li><a href="{{ URL::route('editor.action.index') }}"><i
                                class="fa fa-wrench yellow-sumobo"></i>&nbsp;&nbsp;Action List</a></li>
                    @actionEnd

                    @actionStart('privilege', 'read')
                    <li><a href="{{ URL::route('editor.privilege.index') }}"><i
                                class="fa fa-vcard yellow-sumobo"></i>&nbsp;&nbsp;Privilege List</a></li>
                    @actionEnd

                    @actionStart('branch', 'read')
                    <li><a href="{{ URL::route('editor.branch.index') }}"><i
                                class="fa fa-building yellow-sumobo"></i>&nbsp;&nbsp;Branch</a></li>
                    @actionEnd
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ URL::route('editor.item_type.index') }}"><i
                                        class="fa fa-cubes yellow-sumobo"></i>&nbsp;&nbsp;Type</a></li>
                            @actionEnd
                            @actionStart('item_category', 'read')
                            <li><a href="{{ URL::route('editor.item_category.index') }}"><i
                                        class="fa fa-cubes yellow-sumobo"></i>&nbsp;&nbsp;Category</a></li>
                            @actionEnd
                            @actionStart('item', 'read')
                            <li><a href="{{ URL::route('editor.item.index', [2]) }}"><i
                                        class="fa fa-cube yellow-sumobo"></i>&nbsp;&nbsp;Item</a></li>
                            @actionEnd
                        </ul>
                    </li>
                    @actionEnd
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ URL::route('editor.invoice_type.index') }}"><i
                                        class="fa fa-file-archive-o yellow-sumobo"></i>&nbsp;&nbsp;Category</a></li>
                            @actionEnd
                            @actionStart('vendor', 'read')
                            <li><a href="{{ URL::route('editor.vendor.index') }}"><i
                                        class="fa fa-handshake-o yellow-sumobo"></i>&nbsp;&nbsp;Vendor</a></li>
                            @actionEnd
                            @actionStart('vendoritem', 'read')
                            <li><a href="{{ URL::route('editor.vendoritem.index') }}"><i
                                        class="fa fa-handshake-o yellow-sumobo"></i>&nbsp;&nbsp;Vendor Item</a></li>
                            @actionEnd
                            @actionStart('item', 'read')
                            <li><a href="{{ URL::route('editor.item.index', [3]) }}"><i
                                        class="fa fa-cube yellow-sumobo"></i>&nbsp;&nbsp;Item</a></li>
                            @actionEnd
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            @actionStart('item', 'read')
                            <li><a href="{{ URL::route('editor.item.index', [1]) }}"><i
                                        class="fa fa-cube yellow-sumobo"></i>&nbsp;&nbsp;Item</a></li>
                            @actionEnd
                            @actionStart('item_category', 'read')
                            <li><a href="{{ URL::route('editor.item_category.index') }}"><i
                                        class="fa fa-cubes yellow-sumobo"></i>&nbsp;&nbsp;Item Central Category</a>
                            </li>
                            @actionEnd
                        </ul>
                    </li>
