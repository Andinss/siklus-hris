...
<head>
    ...
    <link rel="stylesheet"
        href="{{ Config::get('constants.path.plugin') }}/font-awesome-4.7.0/css/font-awesome.min.css">
  ...
  folder instead of downloading all of them to reduce the load. -->
    ...
    <link rel="stylesheet"
        href="{{ Config::get('constants.path.plugin') }}/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    <link rel="stylesheet" href="{{ Config::get('constants.path.plugin') }}/jQueryConfirm/jquery-confirm.min.css">
    <link rel="stylesheet" href="{{ Config::get('constants.path.plugin') }}/jQueryConfirm/jquery-confirm.min.css">

    <!-- fixed coloumn -->
    <link rel="stylesheet"
        href="{{ Config::get('constants.path.plugin') }}/datatables/fixedColumns.datatables.min.css">
    ...
    <!-- Datetime Picker -->
    <link rel="stylesheet"
        href="{{ Config::get('constants.path.plugin') }}/datetimepicker/bootstrap-datetimepicker.css">
