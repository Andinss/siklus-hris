...
<head>
    ...
    <link href="{{ asset('constants.path.css') }}/custom.css" rel="stylesheet">
    <!-- dataTables -->
    ...
    <style type="text/css">
        @font-face {
            ...
            src: url({{ asset('constants.path.font') }}/Myriad Pro Regular.ttf) format("truetype");
        }
...
<body>
    ...
    <!-- Bootstrap 3.3.6 -->
    <script src="{{ asset('constants.path.bootstrap') }}/js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        jQuery(function($) {
            ...
            var tableTools_obj = new $.fn.dataTable.TableTools(oTable1, {
                "sSwfPath": "{{ asset('constants.path.swf') }}/copy_csv_xls_pdf.swf",
